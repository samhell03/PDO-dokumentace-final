...
![Moje výlety](../obrazky/SekceMojeVyletyUpravaVyletu.png)

*Výlet je možné editovat také přímo z jeho detailu pomocí stejné ikony v pravé horní části obrazovky.*

![Smazání výletu](../obrazky/UpravaVyletuPrimoZDetailu.png)
...
![Formulář úpravy výletu](../obrazky/UpravitVyletKomplet.png)
...
![Uložit změny](../obrazky/UlozitUpravenyVylet.png)
...
![Uložit změny](../obrazky/UpravenyVyletUlozen.png)
